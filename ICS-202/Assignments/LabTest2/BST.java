...
public class BST<T extends Comparable<? super T>> {
    ...
    private T shallowestLeafRecursive(BSTNode<T> node) {
        ...
        if (shallowestLeafRecursive(node.left) != null && shallowestLeafRecursive(node.right) != null) {

            if(getDepth(node.left) < getDepth(node.right)) { 
                return shallowestLeafRecursive(node.left);}
            else{
                return shallowestLeafRecursive(node.right);
            }
        } else if (shallowestLeafRecursive(node.left) != null) {
            return shallowestLeafRecursive(node.left);
        } else {
            return shallowestLeafRecursive(node.right);
        }
    ...
    private T deepestLeafRecursive(BSTNode<T> node) {
        ...
        if (getDepth(node.left) > getDepth(node.right)){
            return deepestLeafRecursive(node.left);
        }
        else{
            return deepestLeafRecursive(node.right);
        }
    }
