...
public class BinaryHeap<T extends Comparable<T>> 
{
   ...
   private void percolateDown(int index) {
    ...
    public static Comparable findMaxElementInAMinHeap(Comparable[] array){
        // Task03
...
public static Comparable[] removeMaxElementInAMinHeap(Comparable[] array){
    int size = array.length;
    int max = 0;
    for (int i = 0; i < size; i++) {
        if (array[i].compareTo(array[max]) > 0) {
...
public static void main(String[] args) {
    String[] array = {"apple", "lemon", "banana", "mango", "peach"};
    System.out.println(findMaxElementInAMinHeap(array));
    System.out.println(Arrays.toString(removeMaxElementInAMinHeap(array)));
}
