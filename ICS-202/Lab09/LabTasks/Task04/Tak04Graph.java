package Lab09.LabTasks.Task04;
public class Tak04Graph {
        private int numVertices;
        private int matrix[][];

        public Tak04Graph(int numVertices) {
        ...
        public void printDijkstra(int sourceVertex, int [] key){
            ...
            for (int i = 0; i < numVertices ; i++) {
			     if(key[i] >2000000000)
                System.out.printf("Source Vertex: %d to vertex %d shortest distance: %c %n", sourceVertex, i, 0x221E);  // 8734
			     else
